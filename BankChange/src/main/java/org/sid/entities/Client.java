...
public class Client implements Serializable {
	...
	@Column(name = "CODE_CLI") // cette annotation n'est pas obligatoire (on peut l'�liminer comme pour les
								// autres attributs et utiliser le nom de l'attribut comme non du colonne )
	private Long codeClient; // c'est l'identifiant de la table et qui est g�n�rer automatiquement
	private String nomClient;
	private String adresseClient;

	@OneToMany(mappedBy = "client", fetch = FetchType.LAZY) // "client" est attribut $ d'association $ de la classe
															// Compte (association entre la classe Client et Compte )
